...
// Use PUBLIC EC2 BACKEND URL
const BASE_URL = "http://13.232.90.46:8000/dashboard";
...
export const getTop10LeastPopulatedCountries = async () =>
    await apiRequest("/top-10-least-populated-countries");
...
export const getTotalPopulationByContinent = async () =>
    await apiRequest("/total-population-by-continent");
